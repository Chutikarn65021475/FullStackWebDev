...
public class CourseController {
    ...
    public String getById(
        ...
        // System.out.println("------CourseController getId() Result-----");
    ...
    public String postInsertAndUpdate(
        ...
        // System.out.println("-----CourseController postTutorialAndUpdate()-----");
        // System.out.println("course-id: " + param.get("course-id"));
        // System.out.println("course-name: " + param.get("course-name"));

        // System.out.println("-----CourseController postTutorialAndUpdate() Result-----");
