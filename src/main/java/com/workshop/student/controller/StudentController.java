...
public class StudentController {
    ...
    public String getAll(ModelMap model) {
        ...
        // System.out.println("-----StudentController getAll() Resuil-----");
    ...
    public String getById(
        ...
        // System.out.println("-----StudentController getId() Result-----");
    ...
    public String postInsertAndUpdate(
        ...
        System.out.println("-----StudentController postTutorialAndUpdate()-----");
        ...
        System.out.println("-----StudentController postTutorialAndUpdate() Result-----");
